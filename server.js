...
//Search param routes
app.get('/posts/genres/:genre', GetGameByGenre)
app.get('/posts/ratings/:rating', GetGameByRating)
app.get('/posts/platforms/:platforms', GetGameByPlatform)
app.get('/posts/content/:contentDelivery', GetGameByContentDelivery)
